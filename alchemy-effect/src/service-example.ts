...
export const jobApi = Api.effect(
  JobApi,
  Effect.gen(function* () {
...
export default JobFunction.pipe(
  // Option 1 - use a plain object to build the props
  Lambda.make({
    main: import.meta.filename,
    components: [jobApi, jobWorker],
  }),
  Lambda.make(function* () {
    // Option 2 - use a generator function to build the props
