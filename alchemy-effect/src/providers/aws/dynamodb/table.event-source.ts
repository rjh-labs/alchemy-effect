...
import { createInternalTags, hasTags } from "../../util/tags.ts";
import { Account } from "../account.ts";
import { Function, type FunctionBinding } from "../lambda/function.ts";
import type { Consume } from "./table.consume.ts";
import { type AnyTable, type TableAttrs, type TableProps } from "./table.ts";
