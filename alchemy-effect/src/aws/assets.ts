...
export type AssetsError =
  | { readonly _tag: "AssetsUploadError"; readonly message: string; readonly cause?: unknown }
  | { readonly _tag: "AssetsCheckError"; readonly message: string; readonly cause?: unknown };
